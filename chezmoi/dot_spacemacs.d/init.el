...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(nginx
     ...
     nginx
     (org :variables
          ;; org-id-link-to-org-use-id t ;; this breaks org captures?
   ...
   dotspacemacs-additional-packages '(eterm-256color)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '(("RecMonoLinearNerdFontMono"
                                :size 14.0
                                :weight normal
                                :width normal)
                               ("MesloLGS NF"
...
before packages are loaded."
  ...
  ;;                           ;; Problem sequence
  ;;                           (sequence "IDENTIFIED" "ADDRESSING" "|" "SOLVED" )
  ;;                           ;; Idea sequence
  ;;                           (sequence "CREATED" "|" "MAPPED" )
  ;;                           ;; Effort sequence
  ;;                           (sequence "BACKLOG" "TODO" "INPROG" "|" "DONE" "CANCELLED" )))

  (setq org-tag-alist '(
                        ;; Context group
                        ;;   situational contexts in which an item can be engaged (ME)
                        (:startgroup)
                        ("Context")
                        (:grouptags)
                        ("@home" . ?H)
                        ...
                        ;; Category group
                        ;;   essential work-nature of the item (ME)
                        ;; (:startgroup)
                        ;; ("EntryType")
                        ;; (:grouptags)
                        ;; ("Action" . ?A)
                        ...
                        ;; LifeArea
                        ;;   areas of my life that are engaged during an item's work
                        (:startgrouptag)
                        ("LifeArea")
                        (:grouptags)
                        ("work" . ?w)
